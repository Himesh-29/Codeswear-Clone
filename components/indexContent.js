      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <p className="lg:w-2/3 w-full leading-relaxed text-gray-500 text-lg">
              Are you a coder? Ever wondered whether you can wear the code that
              you write? Don't worry, codeswear is here to make you wear the
              code that you love to code
            </p>
          </div>
